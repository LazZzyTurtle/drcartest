(function(api) {
  var cssTemplate = wp.template('car-repair-services-color-scheme') ;

  // Update list of colors when select a color scheme.
  function updateColors(scheme) {
    scheme = scheme || 'default';
    var colors = CarRepairServicesColorScheme[scheme].colors;
  ...
  function updateCSS() {
    ...
    css,
    colors = _.object(colorSettings, CarRepairServicesColorScheme[scheme].colors);
